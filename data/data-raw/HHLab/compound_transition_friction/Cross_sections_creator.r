    ...
    list(
        list(
            ...
            xyz = data.frame(
                x = rep(18, 8),
                y = c(3, 3, 2, 2, 1, 1, 0, 0),
                z = c(0.3, 0.115, 0.115, 0, 0, 0.115, 0.115, 0.3)
            )
        ),
        So = 1.05e-3
    )
...
points_cross_sections <- c(
    0, 1, 2, 2.225, 3, 3.5, 4, 5.27, 6,
    7, 7.28, 8, 9, 9.25, 10, 11, 11.25, 12.25,
    13.25, 14, 14.5, 15, 16, 16.5, 17, 18
)
...
file_path <- "/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/data/processed_data/HHLab/compound_transition_friction/Reach_002.ST"

...
Input_MR <- data.frame(
    reach = c(1, 2, 3),
    KP_start = c(55900, 34500, 19312),
    KP_end = c(34500, 26750, 184)
)
...
for (i in 1:length(Key_Info_XR_MR)) {
    ...
    # # SU:
    # RUG_path <- paste0("/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/data/data-raw/Synthetic_case/Rhone/Calibration/RUGFiles/RUGFile_spatialized_SU_", i, ".RUG")
    ...
    # MAGE:
    RUG_path_HM <- paste0("/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/data/data-raw/Synthetic_case/Rhone/Calibration/RUGFiles/RUGFile_spatialized_SU_by_HM_reach_", i, ".RUG")
...
RUG_path <- "/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/data/data-raw/Synthetic_case/Rhone/Calibration/RUGFiles/RUGFile_spatialized_SU.RUG"
...
RUG_path <- "/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/data/data-raw/Synthetic_case/Rhone/Calibration/RUGFiles/RUGFile_spatialized_HM.RUG"

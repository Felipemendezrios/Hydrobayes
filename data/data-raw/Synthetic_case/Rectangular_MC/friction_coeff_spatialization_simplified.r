...
##########
kmin_spat <- list(
    MR = c(35, 30, 37, 40, 28, 35),
    TR = c(25, 30, 27, 32, 24, 30)
)
...
for (i in 1:length(Key_Info_XR_MR)) {
    ...
    RUG_path <- paste0("/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/data/data-raw/Synthetic_case/Rectangular_MC/Codes_synthetic_friction/RUGFile_spatialized_reach", i, ".RUG")
...
RUG_path <- "/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/data/data-raw/Synthetic_case/Rectangular_MC/Codes_synthetic_friction/RUGFile_spatialized.RUG"

...
setwd("/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/data/data-raw/Durance_Thiercelin/Qgis/code")

file_bathy_Ain <- "/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/data/data-raw/Durance_Thiercelin/_PAMHYR_/PMRiver/default-mage/net/"
bathymetry_Ain <- readLines(file.path(file_bathy_Ain, "Reach_002.ST"))
...
write.table(xyz_df, file = "model_ST_Durance.txt", row.names = FALSE, quote = FALSE)

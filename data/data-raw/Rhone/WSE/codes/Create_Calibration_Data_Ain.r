...
raw_qdt_station_1 <- read.csv(
    file = file.path(
        "/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/data/data-raw/Rhone/WSE/Raw/QdT_station_Ain/",
...
save(all_WSE_Ain, file = "/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/data/processed_data/Rhone/all_observations_AIN.RData")

...
# Estimation: constant in the main channel and second degree in the floodplain (n_kmin = 0 and n_kflood = 2)
...
A constant friction in the main channel and a second degree in the floodplain. Non informative prior were used for all the model's parameters. 
...
MCMC instabilities are observed for all the model's parameters. Non convergence has been atteint during the estimation. 
...
Same instabilites have been constated for all the parameters of the model.

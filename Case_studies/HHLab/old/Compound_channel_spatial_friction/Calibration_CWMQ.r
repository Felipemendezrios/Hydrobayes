...
path_temp_results <- "/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/Case_studies/HHLab/Compound_channel_spatial_friction/Calibration"
...
CalData_sample$Yu_mean_all <- 0.008
...
if (n_degree_Kmin == 0 && n_degree_Kflood == 2) {
    Kmin_prior <- list(
        a0_min_reach_1
        # a1_min_reach_1
    )
...
} else if (n_degree_Kmin == 0 && n_degree_Kflood == 4) {
    Kmin_prior <- list(
        a0_min_reach_1
        # a1_min_reach_1
    )
...
mageDir <- c(
    "/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/Case_studies/HHLab/Compound_channel_spatial_friction/CWMQ18/",
    "/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/Case_studies/HHLab/Compound_channel_spatial_friction/CWMQ12/"
)
### interpolation
...
jump_MCMC_theta_param_user <- c(8, 5, 0.2, 0.2, 0.2, 0.2)
...
pairs(mcmc[, c("a0_min", "a0_flood", "Y5_intercept", "LogPost")])
dev.off()

...
# path <- "/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/Case_studies/HHLab/Compound_channel_spatial_friction_test/Calibration/"
...
# Estimation: constant in the main channel and the floodplain (n_kmin = 0 and n_kflood = 2)
...
MCMC unstabilities are observed for all the parameters. Non convergence has been atteint during the estimation. 
...
ks_literature_floodplain_grass <- data.frame(min = 1 / 0.05, max = 1 / 0.025, mean = 1 / 0.033)
ks_literature_floodplain_wood <- data.frame(min = 1 / 0.017, max = 1 / 0.01, mean = 1 / 0.013)
...
- The estimated values are not coherent.
...
# Estimation (n_kmin = 0 and n_kflood = 2, with lower uncertainty)

## Check MCMC 
```{r}
path <- "/home/famendezrios/Documents/These/VSCODE-R/HydroBayes/HydroBayes_git/Case_studies/HHLab/Compound_channel_spatial_friction_test/Calibration/n_min_0_n_moy_2/"
...
# Estimation (n_kmin = 0 and n_kflood = 4)
...
# Estimation (n_kmin = 0 and n_kflood = 4, with lower uncertainty)
...
- However, this example allows to prove that the methodology is able to estimate constant friction using a picewise function (to be tested)

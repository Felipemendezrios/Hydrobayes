...
load("/home/famendezrios/Documents/These/Cas_etude/Rhone/modelisation/Code_extraction_CL/All_boundary_conditions/metadata.RData")


metadata_modified <- data.frame(
    files = file.path("/home/famendezrios/Documents/These/Cas_etude/Rhone/modelisation/Code_extraction_CL/All_boundary_conditions", paste0(metadata$export_name, ".RData")),
    export_name = metadata$export_name
)

setwd("/home/famendezrios/Documents/These/Cas_etude/Rhone/modelisation/Code_extraction_CL/Specific_boundary_conditions")
